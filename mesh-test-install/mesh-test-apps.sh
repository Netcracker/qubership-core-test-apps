...
transform_crs() {
    local chart_path=$1
    java -jar $PROJECT_ROOT/core-control-plane/mesh-cr-transformer/target/remesh-1.0.0.jar -d $chart_path/templates/ -c $PROJECT_ROOT/mesh-test-install/remesh.yaml
