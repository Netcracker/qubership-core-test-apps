...
import com.netcracker.it.maas.controller.DeploymentFaultController;
import com.netcracker.it.maas.controller.FaultController;
import com.netcracker.it.maas.controller.PatroniFaultController;
...
public enum FailoverProfile {
    ...
    MAAS_RABBIT("maas-rabbit", 2, List.of("maas-agent"), Thresholds.maas(),
            List.of(Fault.ABRUPT_LEADER_LOSS), Fault.ABRUPT_LEADER_LOSS, FailoverProfile::patroni),
    ...
    MAAS_AGENT("maas-kafka", 2, List.of("maas-agent"), Thresholds.maasAgent(),
            List.of(Fault.INSTANCE_LOSS), Fault.INSTANCE_LOSS, FailoverProfile::maasAgent);
    ...
    FailoverProfile(String probe, int operationsPerSecond, List<String> requiredServices,
