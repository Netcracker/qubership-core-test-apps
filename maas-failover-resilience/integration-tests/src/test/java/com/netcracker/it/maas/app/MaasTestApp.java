package com.netcracker.it.maas.app;
...
public class MaasTestApp {

    private static final Logger log = LoggerFactory.getLogger(MaasTestApp.class);
    ...
    public MaasTestApp(URL baseUrl) {
